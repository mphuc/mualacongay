<aside class="wrapper_content_right"> 
    <h1 class="title_admin_right bg_title"><span class="fa fa-globe"></span> Mạng xã hội</h1>
    <div class="table_content_right">  
        <div class="inner_table_content_right">
            <div class="nav_item" > 
                <div class="nav_left_item">
                    <div> 
                        <button type="button" title="Thêm bài viết mới" class="btn btn-info add_mangxahoi toggle_form_add_edit">Thêm liên kết mới <i class="fa fa-globe"></i></button>
                        <div type="submit" title="Xóa bài viết đã chọn" class="btn btn-danger btn_del_more disabled dropdown_togle" id="btn_del_more_mangxahoi">
                            Xóa đã chọn <i class="fa fa-trash-o"></i>
                            <div class="dropdown_menu">
                                <p class="dropdown_title">Bạn có muốn xóa?</p>
                                <input type="button" class="btn btn-info ok_del_more_mangxahoi" value="Đồng ý">
            ...
            <div class="wrapper_table_item">
                <table id="mangxahoi_admin" class="table_item tablesorter" >
                    <thead>
                    <tr> 
                        <th></th>
            ...
            <div class="wrapper_form_add_edit">   
                <!-- hiện thị form add hoặc edit -->
                    <form class="form_add_edit form-horizontal"> 
                        ...
                        <input type="hidden" name="MangXHID" id="MangXHID" val="">
                    </form> 
            </div>
        </div><!-- inner_table_content_right -->
