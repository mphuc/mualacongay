...
class Lock extends CI_Controller {
    ...
    public function submit()
    {
        ...
        {   
            ...
            {
                $_SESSION['lock_ql'] = 1000;
                redirect('/danh-muc/8/san-pham-dac-biet.html', 'location');
            }
            else
            {
                $_SESSION['lock_faile'] = 1000;
