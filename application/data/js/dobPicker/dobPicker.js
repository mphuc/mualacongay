...
jQuery.extend({
  ...
  dobPicker: function(params) {
    ...
    if(typeof(params.dayDefault)==='undefined') params.dayDefault = 'Ngày';
    if(typeof(params.monthDefault)==='undefined') params.monthDefault = 'Tháng';
    if(typeof(params.yearDefault)==='undefined') params.yearDefault = 'Năm';
